...
# The following must be exactly one of: BSD LINUX SYS_V SYS_III SCO_XENIX
OS := LINUX

# The following can include any combination of: -DHSTATS -DMEMORY_BASED -DONEPERLINE -DLSTAT
OPTIONS := -DMEMORY_BASED

CFLAGS += $(STD) -D$(OS) $(OPTIONS)
